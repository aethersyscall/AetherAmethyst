...
[![License](https://img.shields.io/badge/License-Apache_2.0-8839CE?style=for-the-badge&logo=apache)](LICENSE)
[![PRs Welcome](https://img.shields.io/badge/PRs-Welcome-FF70B8?style=for-the-badge&logo=github)](CONTRIBUTING.md)
[![Website](https://img.shields.io/badge/Launch-Experience-9580FF?style=for-the-badge&logo=safari)](https://aethersyscall.github.io/aether-amethyst)
...
I have designed the [Design System and the Palette](https://aethersyscall.github.io/AetherAmethyst), but I need you to bring it to your favorite tools. Whether you use VS Code, Emacs, Terminal, or Slack—if you port it, I will list you here as the official Maintainer for that platform.
...
> **How to join?**  
> 1. Go to the [Landing Page](https://aethersyscall.github.io/aetheramethyst).
> 2. Click the color cards to copy the Hex codes.
> 3. Build the theme for your tool.
> 4. Open a PR to add your name to this table. [Read the Guide](./CONTRIBUTING.md).
